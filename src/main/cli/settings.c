...
// PG_PID_PROFILE
    ...
    { "tpid_curve_p",               VAR_UINT8  | PROFILE_VALUE | MODE_ARRAY, .config.array.length = TPID_CURVE_POINTS, PG_PID_PROFILE, offsetof(pidProfile_t, tpid_curve_p) },
    { "tpid_curve_i",               VAR_UINT8  | PROFILE_VALUE | MODE_ARRAY, .config.array.length = TPID_CURVE_POINTS, PG_PID_PROFILE, offsetof(pidProfile_t, tpid_curve_i) },
    { "tpid_curve_d",               VAR_UINT8  | PROFILE_VALUE | MODE_ARRAY, .config.array.length = TPID_CURVE_POINTS, PG_PID_PROFILE, offsetof(pidProfile_t, tpid_curve_d) },
